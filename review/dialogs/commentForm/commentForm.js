...
var CommentForm = function (reviewService, closeHandler) {
    var  $commentForm = $(htmlMarkupProvider.getHtmlMarkup(commentFormHtml)),
        controls = new CommentFormControls($commentForm);
